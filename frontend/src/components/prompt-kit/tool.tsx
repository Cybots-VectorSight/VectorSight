  ...
  return (
    ...
    >
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger
          className="bg-background hover:bg-accent hover:text-accent-foreground inline-flex h-auto w-full items-center justify-between rounded-md rounded-b-none px-3 py-2 text-sm font-normal transition-all cursor-pointer"
        >
